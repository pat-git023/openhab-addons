...
public class UserStateHandler extends BoschSHCHandler {
    ...
    public void handleCommand(ChannelUID channelUID, Command command) {
        ...
        if (channelUID.getId().equals(CHANNEL_USER_DEFINED_STATE)) {
    ...
    private void updateUserState(String stateId, OnOffType userState) {
        ...
        serviceState.state = userState == OnOffType.ON;
        // this.updateServiceState(userStateService, serviceState);
        try {
