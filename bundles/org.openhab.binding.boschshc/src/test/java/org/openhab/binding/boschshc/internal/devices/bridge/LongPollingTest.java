...
class LongPollingTest {
    ...
    void startLongPolling_receiveUserDefinedState()
        ...
        assertEquals("23d34fa6-382a-444d-8aae-89c706e22155", longPollResultItem.id);
        assertEquals("My User state", longPollResultItem.name);
        assertEquals(true, longPollResultItem.state);
    }
